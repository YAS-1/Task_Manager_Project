...
class SchedulingAssistant:
    ...
    def schedule_reminder(self, deadline, task_name):
        ...
        print(f"Reminder set for task '{task_name}' at {reminder_time.strftime('%Y-%m-%d %H:%M')}") # Prints a message informing the user that a reminder has been set for the created task
